...
<html lang="en-US">
 <head>
   ...
   <title>Reporte de ventas del Programa Economía Solidaria, Cáritas Verapaz</title>
      ...
      <table class="table table-border">
        ...
        <tfoot>
         ...
         <tr class="text-right">
           ...
           <td> Q<?php echo number_format(@total_price($results)[1], 2);?></td>
         </tr>
        </tfoot>
      </table>
      <p> Reporte de ventas correspondiente al programa de Economía Solidaria, por la institución Cáritas Verapaz, Rabinal Baja Verapaz </p>
    </div>
  <?php
    else:
